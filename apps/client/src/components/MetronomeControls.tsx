...
export function MetronomeControls(props: MetronomeControlsProps) {
  const { isPlaying, tempo, beats, isInitializing, serverIsPlaying, onStart, onStop, onSettingsClick, onShareClick } = props;
    ...
    <div className={css({ 
      ...
      <div className={css({ display: 'flex', gap: 4, alignItems: 'center' })}>
        <div className={css({ textAlign: 'center' })}>
          <div className={css({ fontSize: 'sm', color: 'neutral.400', mb: 1 })}>BPM</div>
          <div className={css({ fontSize: '2xl', fontWeight: 'bold', color: 'white' })}>{tempo}</div>
        </div>
        <div className={css({ w: '1px', h: 12, bg: 'neutral.600' })} />
        <div className={css({ textAlign: 'center' })}>
          <div className={css({ fontSize: 'sm', color: 'neutral.400', mb: 1 })}>박자</div>
          <div className={css({ fontSize: '2xl', fontWeight: 'bold', color: 'white' })}>{beats}</div>
        </div>
      </div>
